...
<template>
  <section class="flex min-h-screen flex-col justify-center items-center space-y-5">
    <div>
      <h1 class="uppercase font-mono font-semibold text-2xl underline underline-offset-4 text-shadow-lg shadow-black">Login Dokter Page</h1>
    </div>
