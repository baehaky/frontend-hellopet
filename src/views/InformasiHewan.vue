<template>
  <div class="max-w-7xl mx-auto my-8 px-2">
    <div class="flex justify-center text-2xl md:text-3xl font-bold mb-4">Informasi Hewan</div>
    ...
    <ul class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 p-2 xl:p-5">
      ...
      >
        <a class="relative" href="/tool/writemeai">
          <div class="relative w-full aspect-video">
            ...
            >
              ...
              <p class="font-medium text-sm">AI Writer - Content Writing Assistant &amp; Creator</p>
            </div>
          </div>
        </a>
        ...
        <div class="flex flex-col justify-beetween gap-3 px-4 py-2">
          <p class="text-gray-600 two-lines">
            ...
            content at a fraction of the cost. This advanced solution eliminates the need for manual
            writing and allows users to effortlessly generate content in a few clicks.
          </p>
      ...
      >
        ...
        <div class="flex flex-col justify-beetween gap-3 px-4 py-2">
          <p class="text-gray-600 two-lines">
            Publer is a robust social media management platform offering a range of features
            including post scheduling, collaboration tools, analytics, and AI assistance to
            supercharge your social media strategy across multiple platforms.
          </p>
      ...
      >
        <a class="relative" href="/tool/anyword">
          <div class="relative w-full aspect-video">
            ...
            <div
              class="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white"
            >
              <h2 class="text-xl font-semibold">Anyword</h2>
              <p class="font-medium text-sm">Advanced AI Writing Built for Marketing Results</p>
            </div>
          </div>
        </a>
        ...
        <div class="flex flex-col justify-beetween gap-3 px-4 py-2">
          <p class="text-gray-600 two-lines">
            Anyword is an AI-powered platform trusted by marketing teams across the globe to
            generate, score, and rank content based on predicted performance. With features like
            Custom Scoring AI models, Brand Messaging Management, and a Performance Boost Chrome
            Extension, Anyword provides highly personalized and effective content for every channel.
          </p>
      ...
      >
        <a class="relative" href="/tool/blogseo-ai">
          <div class="relative w-full aspect-video">
            ...
            <div
              class="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white"
            >
              <h2 class="text-xl font-semibold">BlogSEO AI</h2>
              <p class="font-medium text-sm">AI Writer for SEO&zwj; That Follows Best Practices</p>
            </div>
          </div>
        </a>
        ...
        <div class="flex flex-col justify-beetween gap-3 px-4 py-2">
          <p class="text-gray-600 two-lines">
            BlogSEO AI revolutionizes SEO writing. Stay at the top of your SEO game with this
            automated writing tool that generates high-performing blog content. It also offers
            keyword research, internal linking strategy, schema generation, and more.
          </p>
      ...
      >
        <a class="relative" href="/tool/typewise">
          <div class="relative w-full aspect-video">
            ...
            <div
              class="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white"
            >
              <h2 class="text-xl font-semibold">Typewise</h2>
              <p class="font-medium text-sm">AI Communication Assistant</p>
            </div>
          </div>
        </a>
        ...
        <div class="flex flex-col justify-beetween gap-3 px-4 py-2">
          <p class="text-gray-600 two-lines">
            Typewise is an AI Communication Assistant that helps customer service and sales teams
